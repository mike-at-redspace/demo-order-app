...
export class CustomerResolverBase {
    ...
    return await this.service.create({
      ...
      data: {
        ...
        billingAddress: args.data.billingAddress
          ? {
              connect: args.data.billingAddress,
            }
          : undefined,

        shippingAdress: args.data.shippingAdress
          ? {
              connect: args.data.shippingAdress,
            }
          : undefined,
      },
    });
  ...
  async billingAddress(
    ...
    const result = await this.service.getBillingAddress(parent.id);
  ...
  async shippingAdress(
    ...
    const result = await this.service.getShippingAdress(parent.id);
