...
export class AddressControllerBase {
  ...
  async findManyBillingAddress(
    ...
    const results = await this.service.findBillingAddress(params.id, {
      ...query,
      select: {
        billingAddress: {
          select: {
  ...
  @common.Patch("/:id/billingAddress")
  @nestAccessControl.UseRoles({
    resource: "Address",
    action: "update",
    possession: "any",
  ...
  @common.Delete("/:id/billingAddress")
  @nestAccessControl.UseRoles({
    resource: "Address",
    action: "update",
    possession: "any",
